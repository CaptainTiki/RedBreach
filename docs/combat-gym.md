...
| Setting | Value |
|---|---|
| Player / regular bug health | 100 / 150 |
...
- Geometry: `RedBreach/maps/combat_01.map` (Valve 220, 32 units/metre). The approved layout has 22 brushes. Plain Kenney grids repeat at 1 m with 0.125 m subdivisions; see [the corrected scale convention](blockout-textures.md).
